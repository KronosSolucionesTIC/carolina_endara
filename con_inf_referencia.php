...
function abrir() {		
  if(document.getElementById('producto').value == 0){
    ...
    return false;
	  ...
	  cod_pro = document.getElementById('producto').value;	
	  imprimir_inf("inf_movimiento_referencia.php",'0&producto='+cod_pro,'mediano');
  }
}
                  ...
                  <table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
                    ...
                    <tr>
					  ...
					  <table width="524" border="0"  cellpadding="0" align="center">
                        <tr>
						  <td width="322"  class="ctablasup" >REFERENCIAS</td>
						...
						?>
							      ...
							      <td><?php combo_evento_where("producto","producto","cod_pro","cod_fry_pro","",""," WHERE estado_producto = 1 ORDER BY cod_fry_pro") ?></td>
							        <td aling='center' >
