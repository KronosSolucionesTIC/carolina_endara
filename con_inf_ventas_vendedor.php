  ...
  if (restore) selObj.selectedIndex=0;
	...
	function abrir() {	
		...
		if(document.getElementById('fec_fin').value == ""  ||  document.getElementById('fec_ini').value=="") {
			...
			imprimir_inf("inf_ventas_vendedor.php",'0&fec_ini='+fec_ini+"&fec_fin="+fec_fin+"&vendedor="+vendedor,'mediano');
                  ...
                  <table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
                    ...
                    <tr>
                      <td><table width="624" border="0"  cellpadding="0">
                        ...
                        <tr>
                      		<td>Vendedor</td>
                      		<td><?php echo combo_evento_where("vendedor","vendedor","cod_ven","nom_ven","",""," where estado_vendedor =  1") ?></td>
                      	</tr>
						<?php  
