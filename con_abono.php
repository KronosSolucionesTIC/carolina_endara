...
if(!empty($busquedas)) { #codigo para buscar 
 ...
 $sql="SELECT * , CONCAT(cliente.nom1_cli,apel1_cli) as cliente 
 FROM  m_abono 
 
 left JOIN cliente ON (m_abono.cod_cli = cliente.cod_cli)
 left JOIN vendedor ON (m_abono.cod_ven = vendedor.cod_ven) 
...
<tr>
<td valign="top" >
<form id="forma_total" name="forma_total" method="post" action="man_d_abono.php">
                  <table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
                    <tr>
                      <td bgcolor="#D1D8DE"><table width="624" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="17"> 
						  <?php if ($insertar==1) {?>
					  	  <img src="imagenes/agregar.png" width="16" height="16"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='man_d_abono.php?codigo=0&editar=<?php echo $editar?>&insertar=<?php echo $insertar?>&eliminar=<?php echo $eliminar?>'"/>
					  	  <?php } ?></td>
                    ...
                    <tr>
                      <td><table width="624" border="0"  cellpadding="0">
						...
						echo "<tr style='display:none'><td ><form name='forma_0' action='man_d_abono.php'>";
						echo "  </form> </td></tr>  ";						  
						$estilo="ctablablanc";
						$estilo="ctablagris";
						...
						while($db->next_row()) {
							...
							echo "<tr class='$estilo' $cambio_celda> <form name='forma_$db->cod_abo' action='man_d_abono.php'>  ";
							echo "<td >$db->fecha </td>";
							echo "<td >$db->cod_abo </td>";
							echo "<td align='right'>".number_format($db->tot_abo,0,".",".")."</td>";
