...
if($eliminacion==1) {//confirmacion de insercion  
	$campos="estado_mcuenta ='2'";
	$error=editar("m_cuenta",$campos,'cod_cuenta',$eli_codigo); 
	if ($error >=1)
...
if(!empty($busquedas)) { #codigo para buscar 
	...
	$where="where $busquedas and estado_mcuenta = 1";
}#codigo para buscar 
else{
	$where="where estado_mcuenta = 1";
}

$sql="SELECT * FROM m_cuenta $where";
...
<form id="forma_total" name="forma_total" method="post" action="man_admin.php">
                  <table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
                      ...
                      <td bgcolor="#E9E9E9"><table width="624" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="160" valign="middle"><select name="campos" class="textfieldlista" id="campos" >
                            ...
                            <option value="nom_cuenta">Nombre</option>
                    ...
                    <tr>
                      <td><table width="628" border="0"  cellpadding="0">
                        <tr>
                          <td width="120" class="ctablasup">NOMBRE</td>
                          <td  class="ctablasup"  width="142">OPCIONES</td>
                        </tr>
						<? 
						
						echo "<tr style='display:none'><td ><form name='forma_0' action='man_admin.php'>";
						echo "  </form> </td></tr>  ";						  
						$estilo="ctablablanc";
						$estilo="ctablagris";
						...
						while($db->next_row()) {
							...
							echo "<tr class='$estilo' $cambio_celda> <form name='forma_$db->cod_cuenta' action='man_admin.php'>  ";
							echo "<td>$db->nom_cuenta</td>";
...
<form name="forma" method="post" action="con_admin.php">
