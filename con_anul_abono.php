...
if($eliminacion==1) {//confirmacion de insercion  
	$error=eliminar("m_abono",$eli_codigo,"cod_abo");
...
if($where ==''){
 ...
 $sql="select * , CONCAT(cliente.nom1_cli,apel1_cli) as nom_cliente  from m_abono 
left join cliente on cliente.cod_cli=m_abono.cod_cli
INNER JOIN vendedor ON vendedor.cod_ven = m_abono.cod_ven
$where 
ORDER BY cod_abo  DESC ";
//exit;
...
<tr>
<td valign="top" >
<form id="forma_total" name="forma_total" method="post" action="man_anul_abono.php">
                  <table width="644" border="0" cellspacing="0" cellpadding="0" align="center" >
                    <tr>
                      <td bgcolor="#D1D8DE"><table width="624" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="17"> 
						  <?php if ($insertar==10) {?>
					  	  <img src="imagenes/agregar.png" width="16" height="16"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='man_anul_abono.php?codigo=0&editar=<?php echo $editar?>&insertar=<?php echo $insertar?>&eliminar=<?php echo $eliminar?>'"/>
					  	  <?php } ?></td>
                          ...
                          <td width="160" class="ctablaform"><select name="campos" class="textfieldlista" id="campos" >
                            ...
                            <option value="fec_m_abono">Fecha</option>
                            <option value="num_m_abono">No m_abono</option>
                    ...
                    <tr>
                      <td><table width="638" border="0"  cellpadding="0">
						...
						<?php 
						echo "<tr style='display:none'><td ><form name='forma_0' action='man_anul_abono.php'>";
						echo "  </form> </td></tr>  ";						  
						$estilo="ctablablanc";
						$estilo="ctablagris";
						//echo $sql;
						...
						while($db->next_row()) {
							...
							echo "<tr class='$estilo' $cambio_celda> <form name='forma_$db->cod_abo' action='man_anul_abono.php'>  ";
							echo "<td >$db->estado</td>";
							echo "<td >$db->fecha</td>";
							echo "<td >$db->num_abo</td>";
						   ...
						   //impresion	
							echo "<td align='center'><img src='imagenes/mirar.png' width='16' height='16'  style=\"cursor:pointer\" onClick=\"imprimir_inf('ver_abono_v.php',$db->cod_abo,'grande')\" /></td>";	
...
<form name="forma" method="post" action="con_anul_m_abono.php">
