...
if($det==0)
  $where.=" where cod_fac>0   AND tipo_fac = 'B' and  ( $where_cli )  ";
...
<tr>
<td valign="top" >
<form id="forma_total" name="forma_total" method="post" action="man_venta2.php">
            ...
            echo "<tr style='display:none'><td ><form name='forma_0' action='man_venta2.php'>";
            echo "  </form> </td></tr>  ";              
            $estilo="ctablablanc";
            $estilo="ctablagris";
            ...
            while($db->next_row()) {
              ...
              echo "<tr class='$estilo' $cambio_celda> <form name='forma_$db->cod_fac' action='man_venta2.php'>  ";
              echo "<td >$db->fecha </td>";
...
<form name="forma" method="post" action="con_venta2.php">
