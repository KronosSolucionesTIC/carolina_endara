			...
			<TR>
			  ...
			  <table width="100%" border="1" cellpadding="1" cellspacing="1" bordercolor="#333333" id="select_tablas" >
			    <tr >
			      ...
			      <td   class="botones1"><div align="center">COSTO TOTAL</div></td>
		        </tr>
                ...
                <tr id="fila_0"  >
                  ...
                  <td  class="textotabla01"><div align="center">
				   ...
				   <td class="textotabla01"><div align="right"><?=number_format($db->costo_pro,0,".",".")?></div></td>
				<?php 
				//CONSULTA EL PRECIO
				$costo_tot = $db->cant_ref_kar * $db->costo_pro;
				$tot_costo = $tot_costo + $costo_tot;
				?>
				   <td class="textotabla01"><div align="right"><?=number_format($costo_tot,0,".",".")?></div></td>
			    </tr>
				...
				<?
				 ...
				 ?>
				  ...
				  <tr >
                  	<td colspan="5" >&nbsp;</td>
                  	<td>Total:</td>
                  	<td class="textotabla01"><div align="right"><?=number_format($tot_costo,0,".",".")?></div></td>
				  </tr>
              </table></TD>
		  </TR>
			<TR>
