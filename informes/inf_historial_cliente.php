...
function abrir(opc){
	...
	imprimir_inf("../inf_detalle_historial.php",'0&fec_ini='+fec_ini+"&fec_fin="+fec_fin+"&vendedor="+vendedor+"&codigo="+opc,'mediano',"target = '_blank'");
}
</script>
		...
		<TABLE width="98%" border="1" cellpadding="0" cellspacing="0" bordercolor="#999999" >
			...
			<TR>
			  ...
			  <table width="100%" border="1" cellpadding="1" cellspacing="0" bordercolor="#333333">
			  	<tr>
			  		<td><div align="center" class="ctablasup">HISTORIAL CLIENTE DESDE <?=$fec_ini?> HASTA <?=$fec_fin?></div></td>
			    </tr>
				</table>					</TD>
		  </TR>
