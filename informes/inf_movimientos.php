...
?>
                <tr id="fila_0"  >
                  <td  class="textotabla01"><?PHP echo $db->nom1_cli ?></td>
...
<TABLE width="70%" border="0" cellspacing="0" cellpadding="0">
     <tr>
      <td align="center" colspan='5'><a href="../exportar/word/movimientos.php?codigo=<?=$codigo?>"><img src='../imagenes/word.png'></a><a href="../exportar/excel/movimientos.php?codigo=<?=$codigo?>"><img src='../imagenes/excel.png'></a><a href="../exportar/pdf/movimientos.php?codigo=<?=$codigo?>"><img src='../imagenes/pdf.png'></a></td>
    </tr>		
