...
propiedades = 'menubar=0,resizable=1,height='+alto+',width='+ancho+',top='+margintop+',left='+marginleft+',toolbar=0,scrollbars=yes';
 ...
 <title><?php echo $nombre_aplicacion?> -- INFORME DE MOVIMIENTOS POR TERCERO DE
	  		      <?php echo $fec_ini?> HASTA <?php echo $fec_fin?> --</title>
 <style type="text/css">
<!--
		...
		<TABLE width="98%" border="1" cellpadding="0" cellspacing="0" bordercolor="#999999" >
			...
			<TR>
			  ...
			  <table width="100%" border="1" cellpadding="1" cellspacing="0" bordercolor="#333333">
			  	<tr>
			  		<td width="47%" height="26"><div align="center"><span class="Estilo4">INFORME DE MOVIMIENTOS POR TERCERO DE
			...
			<TR>
			  ...
			  <table width="100%" border="1" cellpadding="1" cellspacing="1" bordercolor="#333333" id="select_tablas" >
				<tr>
            		...
            		<td class="botones1"><div align="center">VER MOV</div></td>
				</tr>
				<?
				$db = new Database ();
				...
				WHERE nivel = 5 AND fec_venci >='$fec_ini' AND fec_venci<='$fec_fin' and estado_mov = 1 AND cod_cli = $cliente $where
				ORDER BY fec_emi";
				$db->query($sql);
				$estilo="formsleo";
				$total_debito = 0;
