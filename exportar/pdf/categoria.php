...
<TABLE width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#999999" >
			  	<tr>
			  		<td colspan="3"><div align="center" class="ctablasup">VENTAS X CATEGORIA DESDE '.$fec_ini.' HASTA '.$fec_fin.'</div></td>
			    </tr>
			    <tr>
...
$dompdf->render();
$dompdf->stream("Ventas_categoria_".$fec_ini."_".$fec_fin.".pdf");
?>